...
{
  let sql = `SELECT AVG(COALESCE(weight_body_mass, process.env.AverageWeight)) AS AvgWeight, AVG(step_count) AS AvgStepCount, AVG(COALESCE(dietary_energy, 2200)) AvgCalories,
